                                            ...
                                            <tbody>
                                                <c:forEach var="game" items="${listGame}">
                                                    <tr>
                                                        ...
                                                        <td>${game.result}</td>
                                                        <td>${game.termination_reason}</td>
                                                        <td>
                                                            <c:forEach var="player" items="${listPlayer}">
                                                                <c:if test="${player.player_id == game.white_id}">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"
                                                                        href="${pageContext.request.contextPath}/game/history?id=${game.game_id}"><i
                                                                            class="fas fa-eye text-orange-peel"></i>View
                                                                        History</a>
                                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                                        onclick="confirmDelete(${game.game_id})"><i
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="deleteAccountForm"
                                                        action="${pageContext.request.contextPath}/GamesServlet?action=game-delete"
                                                        method="post">
