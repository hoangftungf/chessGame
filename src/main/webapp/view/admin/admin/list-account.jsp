...
<html class="no-js" lang="">
    ...
    <head>
        ...
        <title>AKKHOR | All Players</title>
                                ...
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        ...
                                        <div style="display: flex; align-items: center; gap: 10px;">
                                            <h3 style="margin: 0;">Sort by rating</h3>
                                            <select style="height: 35px; padding: 5px;" onchange="handleSortChange()">
                                                <option value="asc">⬆ Ascending️</option>
                                                <option value="desc">️⬇ ️Descending</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <!--                                  <a class="dropdown-item"
                                                                                                href="${pageContext.request.contextPath}/manager-account?action=account-update&id=${account.player_id}"><i
